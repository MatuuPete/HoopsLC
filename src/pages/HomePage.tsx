    ...
    <div className="min-h-screen bg-paper text-ink font-body">
      <header className="flex items-center justify-between px-6 md:px-12 py-6 border-b border-chalk">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/login"
            className="border border-ink text-ink px-5 py-2 text-xs font-mono uppercase tracking-widest"
          >
            Sign In
          </Link>
          <Link
      ...
      <main className="px-6 md:px-12 py-16 md:py-24 grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap items-center gap-4 motion-safe:opacity-0 motion-safe:animate-fade-up [animation-delay:380ms]">
            <Link
              to="/signup"
            ...
            <Link
              to="/login"
              className="inline-block border border-ink text-ink px-6 py-3 text-sm font-mono uppercase tracking-widest transition-transform duration-150 hover:-translate-y-0.5"
            >
              Sign In
            </Link>
          </div>
