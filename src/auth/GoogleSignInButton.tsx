  ...
  return (
    <>
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg bg-text px-4 py-2.5 text-sm font-semibold text-bg transition-colors hover:bg-white disabled:cursor-wait disabled:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
      >
